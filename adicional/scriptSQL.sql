...
-- Volcando estructura para tabla constructora.cache
...
-- Volcando datos para la tabla constructora.cache: ~0 rows (aproximadamente)
DELETE FROM `cache`;

-- Volcando estructura para tabla constructora.cache_locks
...
-- Volcando datos para la tabla constructora.cache_locks: ~0 rows (aproximadamente)
DELETE FROM `cache_locks`;

-- Volcando estructura para tabla constructora.country
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `pais_id` varchar(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
-- Añadiendo la restricción de clave foránea
ALTER TABLE `clientes` ADD CONSTRAINT `FK_clientes_country` FOREIGN KEY (`pais_id`) REFERENCES `country` (`id`);

-- Volcando datos para la tabla constructora.clientes: ~0 rows (aproximadamente)
DELETE FROM `clientes`;

-- Volcando datos para la tabla constructora.country: 239 rows
DELETE FROM `country`;
...
-- Volcando estructura para tabla constructora.jobs
...
-- Volcando datos para la tabla constructora.jobs: ~0 rows (aproximadamente)
DELETE FROM `jobs`;

-- Volcando estructura para tabla constructora.job_batches
...
-- Volcando datos para la tabla constructora.job_batches: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla constructora.migrations: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla constructora.sessions
...
-- Volcando datos para la tabla constructora.sessions: ~0 rows (aproximadamente)
