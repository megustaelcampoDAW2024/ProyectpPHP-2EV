    ...
    <tbody>
        @foreach ($tareas as $tarea)
            <tr>
                ...
                <td>
                    <a href="{{ route("tarea.show", ['tarea' => $tarea]) }}" class="btn btn-primary w-100">
                    Detalles 
                ...
                @if (Auth::user()->rol == 'A')
                <td>
                    <a href="{{ route("tarea.index") }}" class="btn btn-warning w-100">
                        Modificar 
                ...
                @if (Auth::user()->rol == 'O')
                    <td>
                        <a href="{{ route("tarea.index") }}" class="btn btn-success w-100">
                            Completar 
