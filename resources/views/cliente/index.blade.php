    ...
    <tbody>
        @foreach ($clientes as $cliente)
            <tr>
                ...
                <td>
                    <a href="{{ route("cliente.show", $cliente->id) }}" class="btn btn-primary w-100">
                        Detalles 
                ...
                <td>
                    <a href="{{ route("cliente.edit", ['cliente' => $cliente]) }}" class="btn btn-warning w-100">
                        Modificar 
                ...
                <td>
                    <a href="#" class="btn btn-danger w-100" data-toggle="modal" data-target="#confirmDeleteModal{{ $cliente['id'] }}">
                        Eliminar 
